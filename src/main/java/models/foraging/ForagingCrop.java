...
public enum ForagingCrop implements TileObject, FarmingEnum {
    ...
    ForagingCrop(String name, Season season, int baseSellPrice, double energy, String symbol) {
        this.name = name;
        this.season = season;
    ...
    public static ForagingCrop randomForagingCrop() {
        ForagingCrop[] values = ForagingCrop.values();
    ...
    public static ForagingCrop fromString(String name) {
        for (ForagingCrop foragingCrop : values()) {
            if (foragingCrop.getName().equalsIgnoreCase(name)) {
                return foragingCrop;
            }
        }
        return null;
